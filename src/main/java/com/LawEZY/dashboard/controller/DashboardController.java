package com.LawEZY.dashboard.controller;

import com.LawEZY.admin.repository.DisputeTicketRepository;
import com.LawEZY.common.response.ApiResponse;
import com.LawEZY.consultation.service.ConsultationService;
import com.LawEZY.payment.repository.PaymentTransactionRepository;
import com.LawEZY.payment.repository.PayoutRequestRepository;
...
public class DashboardController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getAdminDashboard() {
        ...
        map.put("pendingPayoutsCount", payoutRequestRepository.findByStatus(com.LawEZY.payment.enums.PayoutStatus.PENDING).size());
