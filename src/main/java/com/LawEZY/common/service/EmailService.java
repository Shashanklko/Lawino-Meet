...
public class EmailService {
    ...
    public void sendAppointmentConfirmationEmail(String toEmail, String clientName, String meetingCode, 
        ...
        String subject = "LawEZY Appointment Confirmation Pass: " + meetingCode;
        StringBuilder content = new StringBuilder();
        content.append("<h2>🏛️ LawEZY Consultation Confirmation</h2>");
        ...
        content.append("</ul>");
        content.append("<p>Thank you for choosing LawEZY Legal Platform!</p>");
