...
import com.jurisone.chat.model.ChatMessage;
import com.jurisone.chat.model.ChatSession;
import com.jurisone.chat.repository.ChatMessageRepository;
import com.jurisone.chat.repository.ChatSessionRepository;
...
public class ChatServiceImp implements ChatService {
    ...
    @Autowired
    private com.jurisone.ai.service.AiService aiService;
    ...
    public ChatMessageResponse sendMessage(@NonNull SendMessageRequest request) {
        ...
        if (senderUserId != null && senderUserId.equals(session.getUserId())) {
            com.jurisone.user.entity.User user = userRepository.findById(senderUserId)
