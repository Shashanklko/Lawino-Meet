...
public class DashboardController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getAdminDashboard() {
        ...
        map.put("pendingPayoutsCount", payoutRequestRepository.findByStatus(com.jurisone.payment.enums.PayoutStatus.PENDING).size());
