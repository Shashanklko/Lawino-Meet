...
const TOKEN_KEY = 'jurisone_jwt_token';

let currentBaseUrl = localStorage.getItem('jurisone_base_url') || DEFAULT_BASE_URL;

export const getBaseUrl = (): string => currentBaseUrl;
export const setBaseUrl = (url: string): void => {
  currentBaseUrl = url;
  localStorage.setItem('jurisone_base_url', url);
};
